...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 29, 2023 lúc 08:18 AM
...
CREATE TABLE `notifications` (
  ...
  `type_notification` enum('like','comment','join','add_fr') NOT NULL,
  `created_at` datetime DEFAULT current_timestamp(),
  `user_uid` varchar(100) NOT NULL,
...
('349a5c74-e31b-4cb3-87aa-e3be559fa824', '88fdc431-9c21-481f-823c-c0942d308249', 'Tắm biển Cần Giờ', 'Chuyến đi tắm biển giải tress', '2023-12-25', '2023-12-27', 'Ngã tư Thủ Đức', 'Biển Cần Giờ', 2, 'open', '2023-12-25 14:01:31', '2023-12-25 14:01:31'),
...
('a1531aba-4754-4a9a-91ce-4966ef3b07b1', '349a5c74-e31b-4cb3-87aa-e3be559fa824', 'bd89e386-abfc-4065-9b00-3f64ec4c9c84', 'member', 0, NULL);
...
CREATE TABLE `trip_messages` (
  ...
  `soure_uid` varchar(100) NOT NULL,
...
('6a79b4f1', '6a79b4f1-3c1c-4179-8a8f-8542f6aab4b3', 10.845335, 106.794301, 'Lê Văn Việt', 'Lê Văn Việt, Tăng Nhơn Phú A, Quận 9, Thành phố Hồ Chí Minh', 0, 0),
('6a79b4f2', '6a79b4f1-3c1c-4179-8a8f-8542f6aab4b3', 10.849808, 106.811701, 'Trạm Xăng Dầu Tân Phú', '659 Lê Văn Việt, Long Thạnh Mỹ, Quận 9, Thành phố Hồ Chí Minh', 1, 0),
('6a79b4f3', '6a79b4f1-3c1c-4179-8a8f-8542f6aab4b3', 10.893267, 106.82379, 'Trạm Tiếp Nhiên Liệu Hiệp Phú 2', '78/2C Đ. Võ Nguyên Giáp, Bình An, Dĩ An, Bình Dương', 1, 0),
('6a79b4f4', '6a79b4f1-3c1c-4179-8a8f-8542f6aab4b3', 10.845335, 106.794301, 'Cây xăng Tây Nam - BQP', 'VRXM+VXJ, Bình An, Dĩ An, Bình Dương', 1, 0),
('6a79b4f5', '6a79b4f1-3c1c-4179-8a8f-8542f6aab4b3', 10.961922, 106.881669, 'Trạm Xăng Dầu Tân Biên', '327 QL1A, Tân Biên, Thành phố Biên Hòa, Đồng Nai', 1, 0),
('6a79b4f6', '6a79b4f1-3c1c-4179-8a8f-8542f6aab4b3', 11.035085, 107.014836, 'Sửa Xe Hà Luật', 'Vĩnh Cửu, Đồng Nai', 0, 1),
('6a79b4f7', '6a79b4f1-3c1c-4179-8a8f-8542f6aab4b3', 11.100594, 107.044709, 'Hồ trị an', 'Tôn Đức Thắng, TT. Vĩnh An, Vĩnh Cửu, Đồng Nai', 0, 0);
...
('5c737b38-680f-4700-98c8-3dba6ac401c9', 'ha123', NULL, 0, 0, 'hao@gmail.com', '$2b$10$x90AprmfknN0tsWg5EFxdOpVLQvl1FeGyaWoLhZc6iDbS.FxOHr0O', 1, 'bd89e386-abfc-4065-9b00-3f64ec4c9c84', NULL, '98969', NULL, NULL),
...
('984d9723-d4a7-4fa8-a22d-80dff65d87c3', 'tuyenpv', NULL, 0, 0, 'tuyenpv2703@gmail.com', '$2b$10$WTZI4oaMNOvKNCyAFtah..zDIQkXI6g.tdoX4zZS2M6jOkAhOHxsa', 1, '88fdc431-9c21-481f-823c-c0942d308249', NULL, '47046', NULL, NULL),
